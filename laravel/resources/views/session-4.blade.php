...
<body>
    ...
    <div class="sessionHeader absolute">
        ...
        <div class="absolute z-1">
            ...
            <div class="sessionSubtitle leading-3 text-sm">
                Membaca Chord, Hand Signal, dan Open Worship
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col items-center">
        ...
        <br>
        <a href="/story-4-1" @if ($checkpoint < 16) onclick="alert('Pelajari materi sebelumnya terlebih dahulu.'); return false;" @endif>
            <div class="relative">
        ...
        <br>
        <a href="/story-4-2" @if ($checkpoint < 17) onclick="alert('Pelajari materi sebelumnya terlebih dahulu.'); return false;" @endif>
            <div class="relative">
                <img src="..\assets\Class0-1.png" alt="" class="sessionStoryPicture">
                @if ($checkpoint >= 17)
                    <img src="..\assets\ClassAvailable.png" alt=""
        ...
        <br>
        <a href="/story-4-3" @if ($checkpoint < 18) onclick="alert('Pelajari materi sebelumnya terlebih dahulu.'); return false;" @endif>
            <div class="relative">
                <img src="..\assets\Class0-1.png" alt="" class="sessionStoryPicture">
                @if ($checkpoint >= 18)
                    <img src="..\assets\ClassAvailable.png" alt=""
