...
<head>
    ...
    <title>Learning Am</title>
</head>

<body>

    <button type="button" onclick="window.location.href='/session-2-set-12'" id="completedTrainingButton">
    ...
    <div id="learningPage">
        ...
        <img src="..\assets\Am.png" alt="" class="chordVisual">
    ...
    <script type="text/javascript">
        ...
        async function init() {
            ...
            recognizer.listen(result => {
                ...
                const cIndex = classLabels.indexOf("Am");
