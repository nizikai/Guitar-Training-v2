...
<head>
    ...
    <title>Learning Em</title>
</head>

<body>

    <button type="button" onclick="window.location.href='/session-2-set-10'" id="completedTrainingButton">
    ...
    <div id="learningPage">
        ...
        <img src="..\assets\Em.png" alt="" class="chordVisual">
    ...
    <script type="text/javascript">
        ...
        async function init() {
            ...
            recognizer.listen(result => {
                ...
                const cIndex = classLabels.indexOf("Em");
