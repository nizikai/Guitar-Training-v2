...
<body>
    ...
    <button type="button" onclick="window.location.href='/session-3-set-14'" id="completedTrainingButton">
    ...
    <div id="learningPage">
        ...
        <img src="..\assets\F.png" alt="" class="chordVisual">
    ...
    <script type="text/javascript">
        ...
        async function init() {
            ...
            recognizer.listen(result => {
                ...
                const cIndex = classLabels.indexOf("F");
