...
<head>
    ...
    <title>Learning G</title>
</head>

<body>

    <button type="button" onclick="window.location.href='/session-1-set-8'" id="completedTrainingButton">
    ...
    <div id="learningPage">
        ...
        <img src="..\assets\G.png" alt="" class="chordVisual">
    ...
    <script type="text/javascript">
        ...
        async function init() {
            ...
            recognizer.listen(result => {
                ...
                const cIndex = classLabels.indexOf("G");
