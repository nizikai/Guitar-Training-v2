...
<body>
    ...
    <button type="button" onclick="window.location.href='/session-1-set-6'" id="completedTrainingButton">
    ...
    <div id="learningPage">
        ...
        <img src="..\assets\C.png" alt="" class="chordVisual">
    ...
    <script type="text/javascript">
        ...
        async function init() {
            ...
            recognizer.listen(result => {
                ...
                const cIndex = classLabels.indexOf("C");
