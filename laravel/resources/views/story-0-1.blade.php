...
<head>
    ...
    <title>More than just a Guitar Training</title>
</head>
...
<body>
    ...
    <div class="storyHeader">
            ...
            <div class="storyLabel truncate leading-4 z-10 mt-9 ml-16">
                The Introduction
                <strong>
                    <br>More than just a Guitar Training
                </strong>
            </div>
        </div>
    </div>

    <a href="/session-0-set-1">
    ...
    <div class="story">
        ...
        <div data-slide="slide" class="slide">
            <div class="slide-items">
                <img src="..\assets\Story0-1-1.jpg" alt="">
                <img src="..\assets\Story0-1-2.jpg" alt="">
            </div>
